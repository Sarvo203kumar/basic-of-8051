...
void Lcd8_Init()
{
	Lcd8_Command(0x38);Delay(10);		//to select function set
	Lcd8_Command(0x06);Delay(10);		//entry mode set
	Lcd8_Command(0x0c);		//display on
	Delay(10);Lcd8_Command(0x01);		//clear display
}
...
void Delay_(unsigned int del,unsigned char del1)
{
	unsigned int del2;
	del2=del;
	do
